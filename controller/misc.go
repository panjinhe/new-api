...
func SendEmailVerification(c *gin.Context) {
	...
	content := common.BuildEmailVerificationTemplate(code, common.VerificationValidMinutes, system_setting.ServerAddress)
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if model.IsEmailAlreadyTaken(email) {
		...
		content := common.BuildPasswordResetTemplate(link, common.VerificationValidMinutes, system_setting.ServerAddress)
		err := common.SendEmail(subject, email, content)
		if err != nil {
