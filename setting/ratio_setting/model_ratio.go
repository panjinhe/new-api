...
var defaultModelRatio = map[string]float64{
	...
	"gpt-5.2-2025-12-11":               0.875, // $1.75 / 1M tokens
	"gpt-5.2-chat-latest":              0.875, // $1.75 / 1M tokens
	"gpt-5.2-codex":                    0.875, // $1.75 / 1M tokens
	"gpt-5.2-pro":                      10.5,  // $21 / 1M tokens
	"gpt-5.2-pro-2025-12-11":           10.5,  // $21 / 1M tokens
	"gpt-5":                            0.625,
