...
type TaskPrivateData struct {
	...
	BillingSource    string              `json:"billing_source,omitempty"`     // "wallet"、"subscription" 或 "bucket"
	BillingRequestId string              `json:"billing_request_id,omitempty"` // 预扣请求 ID，用于限时额度包退款/补扣
