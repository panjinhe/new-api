	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/classify", controller.ClassifyUsersByPaymentAndUsage)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/grant_quota_to_all_users", controller.GrantQuotaToAllUsers)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/routing_cooldown/clear", controller.ClearChannelRoutingCooldown)
